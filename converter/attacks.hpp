...
{
    u64 attacks = rookAttacks(sq, occupancy);
    return attacks ^ rookAttacks(sq, occupancy ^ (attacks & blockers));
}

inline u64 xrayBishop(Square sq, u64 occupancy, u64 blockers)
{
    u64 attacks = bishopAttacks(sq, occupancy);
    return attacks ^ bishopAttacks(sq, occupancy ^ (attacks & blockers));
}
